...
| |結果 |試行結果  Ok：正解  StartTimeout：トリガ画面タッチ・タイムアウト  TrialTimeout：正解できない時のタイムアウト  IlegalExit:途中退室  TriggerTouch:トリガータッチ  IncorrectTouchNG:不正解タッチ  ExitAfterFeeding:給餌後退室  OkEpisode:エピソードOK|
